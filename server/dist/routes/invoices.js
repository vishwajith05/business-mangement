...
router.get('/:id/pdf', auth_1.authenticateToken, (req, res) => {
    try {
        ...
        if (sale.customerEmail)
            doc.fontSize(9).fillColor('#475569').text(`Email: ${sale.customerEmail}`);
        if (sale.customerPhone)
            doc.fontSize(9).fillColor('#475569').text(`Phone: ${sale.customerPhone}`);
