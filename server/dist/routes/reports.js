...
router.get('/excel/products', auth_1.authenticateToken, async (req, res) => {
    try {
...
router.get('/excel/sales', auth_1.authenticateToken, async (req, res) => {
    try {
        const sales = memoryStore_1.memoryStore.getSales(req.user);
        const workbook = new exceljs_1.default.Workbook();
